...
def KMD_analysis( # NOTE: Give default parameters!
    ...
    for j in range(len(m_diffs)):
        ...
        Mod_sorted_Df.sort_values('min Homologues', inplace=True) #nach aufsteigendem modulo sortieren
