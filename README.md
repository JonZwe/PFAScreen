...
PFΔScreen can be installed and executed within the standard Python environment or by using the Anaconda distribution. To make installation and use as easily as possible, PFΔScreen can be automatically installed with the Installation.bat file and executed with the Run_PFAScreen.bat file. In the following, the three steps needed for a simple installation are explained.

### Automated installation

- Download the PFΔSScreen by clicking on the green “Code” button and click “Download ZIP”. When downloaded, unzip the folder and move it to a local folder on your computer. 
...
PFΔScreen dependencies can also be installed within the standard Python environment with the following command:
